                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Edit Augmented Reality</li>
                        </ol>
                    </nav>
                </div>
            </div>
                    ...
                    <div class="card border-top border-0 border-4 border-primary">
                        <div class="card-body p-5">
                            <div class="card-title d-flex align-items-center">
                                ...
                                <h5 class="mb-0 text-primary">Edit Augmented Reality</h5>
                            </div>
                            <hr>
                            <form action="{{ route('augmented-reality.update', $ar->id) }}" method="POST" enctype="multipart/form-data"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="nama_objek" name="nama_objek"
                                        value="{{ old('nama_objek', $ar->nama_objek) }}" required>
                                    @error('nama_objek')
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="file" class="form-control" id="objek_3d" name="objek_3d">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="file" class="form-control" id="pattern_pattern" name="pattern_pattern">
                                    <small class="text-muted">Biarkan kosong jika tidak ingin mengubah file</small>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="file" class="form-control" id="pattern_image" name="pattern_image">
                                    <small class="text-muted">Biarkan kosong jika tidak ingin mengubah file</small>
                                    @error('pattern_image')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
